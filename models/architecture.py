...
def make_encoder(input_shape=(256, 256, 3)): 
    ...
    # Concatenate inputs along channel axis -> (256, 256, 6) 
    ...
    stego_output = layers.Conv2D(3, (3, 3), padding='same', activation='sigmoid', 
name='stego_output')(x) 
 
    return models.Model(inputs=[cover_input, secret_input], outputs=stego_output, 
name='Encoder') 
...
def make_decoder(input_shape=(256, 256, 3)): 
    ...
    reveal_output = layers.Conv2D(3, (3, 3), padding='same', activation='sigmoid', 
name='reveal_output')(x) 
...
def get_steganography_model(input_shape=(256, 256, 3)): 
    ...
    return models.Model(inputs=[cover_input, secret_input], outputs=[stego_img, 
revealed_secret], name='StegoNet') 
